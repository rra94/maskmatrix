...
def unmold_mask(bbox, mask, image_shape):
...
#             seg_for_display.append(unmold_mask(det[0:4], seg, (640,640)))

#         seg_for_display = unmold_mask(np.array(dets)[:,0:4], np.array(segs), (640,640))
